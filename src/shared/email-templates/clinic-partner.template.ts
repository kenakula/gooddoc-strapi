...
export const clinicPartnerTemplate = ({
  name,
  email,
  phone,
  comment,
  ...
  return `
    ...
    <body style="margin: 0;padding: 0;font-family: Arial, Helvetica, sans-serif;font-size: 16px;">
      <div class="container" style="padding: 20px;">
        <h1 style="font-size: 32px;text-align: center;">Заявка на партнерство от клиники</h1>
        <h2 style="font-size: 28px;">Отправитель:</h2>
        <table style="border: 1px solid black;border-collapse: collapse;">
          <tr>
            <td style="border: 1px solid black;padding: 5px 10px;">Название клиники</td>
            <td style="border: 1px solid black;padding: 5px 10px;">${clinicName}</td>
          </tr>
          <tr>
            <td style="border: 1px solid black;padding: 5px 10px;">Контактное лицо</td>
